...
struct MyVariables {
    ...
    // Goa
    static var Goa = Restaurant(nom: "Goa", horraireDebut:"8", horraireFin:"15",telephone:"0645789652",adresse:"14 rue brocherie",logo2: #imageLiteral(resourceName: "logoRest"), plats: [platGoa, platGoa2, platGoa3])
    ...
    // Chicken Alpes
    static var chickenAlpes = Restaurant(nom: "Chicken Alpes", horraireDebut:"8", horraireFin:"15",telephone:"0626263545",adresse:"14 rue salamandre",logo2: #imageLiteral(resourceName: "image16"), plats: [platChicken, platChicken2, platChicken3 ])
    ...
    // O'Tacos
    static var oTacos = Restaurant(nom: "O'Tacos", horraireDebut:"8", horraireFin:"15",telephone:"0626263545",adresse:"14 rue salamandre",logo2: #imageLiteral(resourceName: "image20"), plats: [platOtacos, platOtacos2, platOtacos3 ])
